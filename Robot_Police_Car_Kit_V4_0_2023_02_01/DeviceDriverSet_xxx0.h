...
#endif*/
  void DeviceDriverSet_Motor_control(uint8_t direction_A, uint8_t speed_A,  //Group A motor parameters
...
#endif*/
  void DeviceDriverSet_ULTRASONIC_Get(volatile uint16_t *ULTRASONIC_Get /*out*/);
...
#endif*/
  unsigned int DeviceDriverSet_Servo_position(unsigned int PIN_Servo);
  void DeviceDriverSet_Servo_control(unsigned int Position_angle);
  void DeviceDriverSet_Servo2_control(void);
...
#define aRECV_10 16728765
#define aRECV_11 16730805
#define aRECV_12 16732845
/*B:*/
...
#define bRECV_10 851901943
#define bRECV_11 465573243
#define bRECV_12 1053031451
};
