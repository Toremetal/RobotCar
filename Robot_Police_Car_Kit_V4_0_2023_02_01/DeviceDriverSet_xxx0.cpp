...
*/
void DeviceDriverSet_Motor::DeviceDriverSet_Motor_control(uint8_t direction_A, uint8_t speed_A,  //Group A motor parameters
                                                          uint8_t direction_B, uint8_t speed_B,  //Group B motor parameters
...
void DeviceDriverSet_ULTRASONIC::DeviceDriverSet_ULTRASONIC_Get(volatile uint16_t *ULTRASONIC_Get /*out*/) {
...
#endif*/
unsigned int DeviceDriverSet_Servo::DeviceDriverSet_Servo_position(unsigned int PIN_Servo) {
...
void DeviceDriverSet_Servo::DeviceDriverSet_Servo2_control(void) {  //Position_angle
  unsigned int Pos = digitalRead(PIN_Servo_y);
  //Serial.print(digitalRead(PIN_Servo_y));
  if (Pos == 0) {
    pinMode(PIN_Servo_y, LOW);
  } else {
    pinMode(PIN_Servo_y, HIGH);
  }
}
...
void DeviceDriverSet_Servo::DeviceDriverSet_Servo_controls(uint8_t Servo, unsigned int Position_angle) {
  ...
  {
    if (Position_angle <= 7)  //minimum angle control
    {
      Position_angle = 7;
    }
  ...
  if (irrecv.decode(&results)) {
    ...
    switch (results.value) {
      ...
      case /* constant-expression */ bRECV_9:
        /* code */ *IRrecv_Get = 14;
        break;
      case /* constant-expression */ aRECV_10:
      case /* constant-expression */ bRECV_10:
        /* code */ *IRrecv_Get = 15;
        break;
      case /* constant-expression */ aRECV_11:
      case /* constant-expression */ bRECV_11:
        /* code */ *IRrecv_Get = 16;
        break;
      case /* constant-expression */ aRECV_12:
      case /* constant-expression */ bRECV_12:
        /* code */ *IRrecv_Get = 17;
        break;
      default:
        // *IRrecv_Get = 5;
